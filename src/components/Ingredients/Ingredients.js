...
import store, {INGREDIENT_LIST} from '../../store'
...
class Ingredients extends Component {
  constructor(props) {
    ...
    this.state = {
      ingredientList: reduxState.ingredientList,
      input: ""
    };
  }
  componentDidMount(){
  ...
  addIngredient() {
    store.dispatch({type:INGREDIENT_LIST, payload: this.state.input})
    this.setState({
      input: ""
    });
  }
